...
/**
* 使用说明，
resource_parser_url = https://raw.githubusercontent.com/lucifer0822lee/learngit/master/resource-parser.js
...
function Parser() {
  ...
  if (type0 != "web" && type0 != "wrong-field" && type0 != "JS-0"){
    ...
    if (version >= 670 && typec!="") { //尝试跳转到正确类型
      ...
      const bug_linkx = { "open-url": flink, "media-url": "https://https://t.me/+G94Kvb-4foQzYzA5" } // bug linkx
